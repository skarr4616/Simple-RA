...
TreeNode *TreeNode::tree_node_factory(NodeType node_type)
{
    ...
    {
    case LEAF:
        new_tree_node = new LeafNode();
        break;
    case INTERNAL:
        new_tree_node = new InternalNode();
        break;
    }
...
TreeNode *TreeNode::tree_node_factory(TreePtr tree_ptr)
{
    ...
    case INTERNAL:
        return new InternalNode(tree_ptr);
    }
}
...
TreeNode *TreeNode::tree_node_factory(const TreePtr &child_tree_ptr1, const TreePtr &child_tree_ptr2)
{
    ...
    left_child_node->parent_ptr = new_internal_node->tree_ptr;
    right_child_node->parent_ptr = new_internal_node->tree_ptr;
...
ostream &TreeNode::write(ostream &os) const
{
    if (&os == &cout)
    {
        ...
        // Parent pointer
        os << "parent node id: " << this->parent_ptr << endl;
    }
    else
    {
        os << this->node_type << endl;
