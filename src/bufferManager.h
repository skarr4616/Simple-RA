...
class BufferManager
{
    ...
    Page *getPtrFromPool(string pageName);
    Page *insertPtrIntoPool(string tableName, int pageIndex);
...
public:
    ...
    Page *getPagePtr(string tableName, int pageIndex);

    Page getPage(string tableName, int run, int subfile, int pageIndex);
    Page insertIntoPool(string tableName, int run, int subfile, int pageIndex);
    void removeFromPool(string tableName, int pageIndex);
    void writePage(string tableName, int run, int subfile, int pageIndex, vector<vector<int>> rows, int rowCount);
    void deleteFile(string tableName, int run, int subfile, int pageIndex);
};